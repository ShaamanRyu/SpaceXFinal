...
def get_scatter_chart(entered_site, entered_payload):
    ...
    filtered_df=spacex_df[slide]
    title=''
    if entered_site == 'ALL':
        title='Launches for all sites for payload range of ' + str(low) + ' to ' + str(high)
    else:
        filtered_df=spacex_df[spacex_df['Launch Site']==entered_site]
        title='Launches for ' + entered_site + ' for payload range of ' + str(low) + ' to ' + str(high)
